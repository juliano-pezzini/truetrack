...
class StoreAutoRuleRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'pattern' => [
                ...
                'min:2',
                'max:100',
                'regex:/^[a-zA-Z0-9\s\-_\.\'&]+$/', // Alphanumeric, spaces, common punctuation
            ],
            'category_id' => [
                'required',
                'integer',
            ...
            'priority' => [
                ...
                'min:1',
                'max:1000',
                // Ensure priority is unique for this user (allow current rule if updating)
