...
return new class() extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('xlsx_imports', function (Blueprint $table) {
            $table->boolean('is_forced')->default(false)->after('mapping_config');
        });
        ...
        DB::statement("CREATE UNIQUE INDEX IF NOT EXISTS xlsx_imports_hash_account_active_unique ON xlsx_imports (file_hash, account_id) WHERE status IN ('pending', 'processing', 'completed') AND is_forced = false");
    }
