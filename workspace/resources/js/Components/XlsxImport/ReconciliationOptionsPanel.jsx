    ...
    return (
        <div className="space-y-4">
            <div className="flex items-start">
                ...
                />
                <div className="ml-3">
                    <label htmlFor="create_reconciliation" className="font-medium text-gray-700 dark:text-gray-300">
            ...
            {enabled && (
                <div className="ml-6 space-y-4 pl-4 border-l-2 border-gray-200 dark:border-gray-700">
                    <div>
                        <InputLabel htmlFor="statement_date" value="Statement Date *" />
                        <input
                            id="statement_date"
                            type="date"
                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                            value={statementDate}
                    ...
                    <div>
                        ...
                        <div className="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input
                                ...
                                type="number"
                                step="0.01"
                                className="pl-7 block w-full border-gray-300 rounded-md shadow-sm dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
